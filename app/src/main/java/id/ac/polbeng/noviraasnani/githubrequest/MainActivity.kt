package id.ac.polbeng.noviraasnani.githubrequest


import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.Toast
import id.ac.polbeng.noviraasnani.githubrequest.databinding.ActivityMainBinding
import okhttp3.Call
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnGetInfo.setOnClickListener {
            ...
            if(loginID.isEmpty()){
                Toast.makeText(applicationContext, "Silah masukan login id
                        akun github Anda!", Toast.LENGTH_SHORT).show()
            }else{
